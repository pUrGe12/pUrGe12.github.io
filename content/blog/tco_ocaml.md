...
These numbers are specially tagged, they are called `tagged integers`. OCaml uses these tagged versions to help the garbage collector. How exactly? I think I will move this to a separate post. Checkout [this blog](https://purge12.github.io/blog/ocaml-compiler-tagged-integers/).
