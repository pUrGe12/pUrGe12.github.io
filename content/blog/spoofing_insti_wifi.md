...
- I can't directly act as an `ISP` using just a wifi adapter (at least that's what I think, I am still researching this area) so I can't really provide internet access at all. But that's alright I can just get the creds and tell them to get lost.
